...
echo "export PATH='$PATH:/opt/openmpi/3.1.2/bin'" >> /users/DT899836/.bashrc
echo "export LD_LIBRARY_PATH='$LD_LIBRARY_PATH:/opt/openmpi/3.1.2/lib/'" >> /users/DT882578/.bashrc
cd ..
