...
echo "export PATH='$PATH:/opt/openmpi/3.1.2/bin'" >> /users/phantomsjn/.bashrc
echo "export LD_LIBRARY_PATH='$LD_LIBRARY_PATH:/opt/openmpi/3.1.2/lib/'" >> /users/phantomsjn/.bashrc
cd ..
